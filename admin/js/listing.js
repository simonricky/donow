		...
		$.ajax({
			...
			if(response.status == 'success')
			{
				$.each(response.result,function(key,value){
						...
						html +='<nav>';
						html +='<ul>';
						html +='<li><a href="javascript:void(0);" data-toggle="tooltip" title="Edit Ad" id="edit_'+value.id+'"><i class="fa fa-pencil"></i></a></li>';
						html +='<li><a href="javascript:void(0);" data-toggle="tooltip" title="Delete Ad" id="delete_'+value.id+'"><i class="fa fa-times"></i></a></li>';
						html +='</ul>';
						html +='</nav>';
						html +='</div>';
